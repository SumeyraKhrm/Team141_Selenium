...
public class C04_Locators_ByClassName {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement aramaKutusu = driver.findElement(By.id("global-search"));  //burası unique alan

        // dress icin arama yapin
        aramaKutusu.sendKeys("dress" + Keys.ENTER);
       // aramaKutusu.submit();  // arama tuşuna basar
        ...
        // digit olmayan yani sayı olmayan herşeyi yok et
