...
public class C02_Xpath {
    public static void main(String[] args) throws InterruptedException {
        ...
        // By.xpath yerine kullanılabilir fakat daha az tercih ediliyor

        // System.out.println(ilkUrunFiyatElementi.getText()); // $50.00

        String urunFiyatStr = ilkUrunFiyatElementi.getText()
                .replaceAll("\\D",""); //5000

        double urunFiyat = Double.parseDouble(urunFiyatStr)/100;

        if(urunFiyat >=40 && urunFiyat<=200){
